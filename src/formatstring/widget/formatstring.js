...
define('formatstring/widget/formatstring', ['dojo/_base/declare', 'mxui/widget/_WidgetBase', 'dijit/_TemplatedMixin',
    'mxui/dom', 'dojo/dom', 'dojo/dom-class', 'dojo/_base/lang', 'dojo/text',
    'dojo/_base/kernel', 'dojo/text!formatstring/widget/template/formatstring.html'
], function (declare, _WidgetBase, _TemplatedMixin, dom, dojoDom, domClass, lang, text, dojo, widgetTemplate) {
	'use strict';
